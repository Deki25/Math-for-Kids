...
public class ThirdGradeScript : MonoBehaviour 
{
	...
	void Square()
	{
		...
		if (LanguageScript.isEnglish == true)
			SquareText.text = "What's the perimeter of square if his side a = " + a + "cm";
		else if (LanguageScript.isSerbian == true)
			SquareText.text = "Koliki je obim kvadrata ako je njegova stranica a = " + a + "cm";
	...
	void Rectangle()
	{
		...
		if (LanguageScript.isEnglish == true)
			...
			SquareText.text = "Koliki je obim pravougaonika ako je njegova stranica a = " + a + "cm i b = " + b + "cm";
	...
	void Division()
	{
		firstNumber = Random.Range (2, 50);
		secondNumber = Random.Range(2, 50);
